...
contract SwapCurveTest is Test {
    ...
    function test_DirectSwap() public {
        ...
        uint256 amountOut = swapCurve.swap(address(inputToken), address(outputToken), AMOUNT, address(gasToken), 0);
    ...
    function test_SwapWithGasFee() public {
        ...
        uint256 amountOut =
            swapCurve.swap(address(inputToken), address(outputToken), AMOUNT, address(gasToken), GAS_FEE);
    ...
    function test_SwapWithTokenName() public {
        ...
        uint256 amountOut =
            swapCurve.swap(address(inputToken), address(outputToken), AMOUNT, address(gasToken), 0, "TEST");
